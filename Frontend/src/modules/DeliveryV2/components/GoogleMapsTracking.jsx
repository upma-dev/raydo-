...
import raydoDeliveryRider from '../../Food/assets/raydo-delivery-rider.png'
...
const getDeliveryIconUrl = () => raydoDeliveryRider
    ...
    if (!directionsRendererRef.current) {
      directionsRendererRef.current = new window.google.maps.DirectionsRenderer({
        ...
        preserveViewport: true, // Preserve viewport - we'll center manually
                      polylineOptions: {
                        strokeColor: '#3b82f6', // Bright blue like Raydo Partner
                        strokeWeight: 6,
